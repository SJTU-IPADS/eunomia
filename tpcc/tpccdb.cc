...
constexpr float Item::MIN_PRICE;
constexpr float Item::MAX_PRICE;
constexpr float Warehouse::MIN_TAX;
constexpr float Warehouse::MAX_TAX;
constexpr float Warehouse::INITIAL_YTD;
constexpr float District::MIN_TAX;
constexpr float District::MAX_TAX;
constexpr float District::INITIAL_YTD;  // different from Warehouse
constexpr float Customer::MIN_DISCOUNT;
constexpr float Customer::MAX_DISCOUNT;
constexpr float Customer::INITIAL_BALANCE;
constexpr float Customer::INITIAL_CREDIT_LIM;
constexpr float Customer::INITIAL_YTD_PAYMENT;
const char Customer::GOOD_CREDIT[] = "GC";
const char Customer::BAD_CREDIT[] = "BC";
constexpr float OrderLine::MIN_AMOUNT;
constexpr float OrderLine::MAX_AMOUNT;
const char NewOrderOutput::INVALID_ITEM_STATUS[] = "Item number is not valid";
constexpr float History::INITIAL_AMOUNT;
